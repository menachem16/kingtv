...
class _PlayState extends State<Play> {
  ...
  Animation<double> scaleVideoAnimation = const AlwaysStoppedAnimation<double>(1.0);
  ...
  void setTargetNativeScale(double newValue) {
    ...
    scaleVideoAnimation = Tween<double>(begin: 1.0, end: newValue).animate(CurvedAnimation(
  ...
  Future<void> _forcePortrait() async {
    ...
    await SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual, overlays: SystemUiOverlay.values); // to re-show bars
  }
