import 'package:xtream/Components/Input.dart';
import 'package:xtream/Screens/Home.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    Future login() async {
      ...
      var url = Uri.http(host, 'player_api.php', {'username': username, 'password': password});
      try {
        setState(() {
          loading = true;
        });
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: allFilled || loading ? Colors.deepPurple.withOpacity(0.5) : Colors.deepPurple,
                      borderRadius: const BorderRadius.all(Radius.circular(12)),
                    ),
                    child: Center(
                      child: Text(
                        'Login',
                        style: TextStyle(color: allFilled || loading ? Colors.white.withOpacity(0.5) : Colors.white, fontWeight: FontWeight.w500, fontSize: 18),
                      ),
                    ),
                  ),
                ),
